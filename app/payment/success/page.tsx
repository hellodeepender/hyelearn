  ...
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md text-center">
        ...
        <h1 className="text-2xl font-bold text-brown-800 mb-2">Welcome to {brandName} Full Access!</h1>
        <p className="text-brown-500 mb-8">
          Your subscription is active. Your child now has access to the complete K-5 {tc("language")} curriculum.
        </p>
