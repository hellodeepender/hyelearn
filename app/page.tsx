      ...
      <header className="fixed top-0 w-full bg-warm-white/80 backdrop-blur-sm border-b border-brown-100 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6">
            ...
            <Link href="/learn" className="hidden md:inline text-brown-600 hover:text-brown-800 text-sm">{tc("curriculum")}</Link>
      ...
      <main>
        ...
        <section className="relative pt-16 min-h-[600px] md:min-h-[700px] flex items-center">
          <div className="absolute inset-0 bg-brown-800">
            <Img src={locale === "el" ? "/images/hero-greece-el.jpg" : locale === "ar" ? "/images/hero-arabic.jpg" : "/images/hero-ararat.jpg"} alt={t("heroImageAlt")} priority className="opacity-40" />
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-brown-100">
                <Img src={locale === "el" ? "/images/screenshot-lesson-el.jpg" : locale === "ar" ? "/images/screenshot-lesson-ar.jpg" : "/images/screenshot-lesson.jpg"} alt={t("feature1ImageAlt")} />
              </div>
              <div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div className="md:order-2 relative aspect-[4/3] rounded-2xl overflow-hidden bg-brown-100">
                <Img src={locale === "el" ? "/images/screenshot-dashboard-el.jpg" : locale === "ar" ? "/images/screenshot-dashboard-ar.jpg" : "/images/screenshot-dashboard.jpg"} alt={t("feature2ImageAlt")} />
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-brown-100">
                <Img src={locale === "el" ? "/images/kids-tablet-el.jpg" : locale === "ar" ? "/images/kids-tablet-ar.jpg" : "/images/kids-tablet.jpg"} alt={t("feature3ImageAlt")} />
              </div>
              <div>
        ...
        <section className="relative py-24 px-6">
          <div className="absolute inset-0 bg-brown-800">
            <Img src={locale === "el" ? "/images/greek-parthenon-el.jpg" : locale === "ar" ? "/images/ayesha-firdaus.jpg" : "/images/alphabet-monument.jpg"} alt={t("ctaImageAlt")} className="opacity-30" />
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-brown-700 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.linkedin.com/company/diasporalearn/" target="_blank" rel="noopener noreferrer" className="text-brown-500 hover:text-brown-300 transition-colors" aria-label="LinkedIn">
