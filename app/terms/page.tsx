...
export const metadata: Metadata = { title: "Terms of Service — HyeLearn" };
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-brown-600 text-sm leading-relaxed">
          <section>
            ...
            <p>By accessing or using HyeLearn, you agree to be bound by these Terms of Service. If you do not agree, do not use the service.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-brown-800">2. Description of Service</h2>
            <p>HyeLearn is an Armenian language learning platform designed for children in Kindergarten through Grade 5. It provides structured lessons, interactive exercises, and progress tracking.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc ml-5 space-y-1">
              ...
              <li>Payments are processed securely by Stripe. HyeLearn never sees or stores your credit card information.</li>
              ...
              <li><strong>Refunds:</strong> Contact support@hyelearn.com within 7 days of a charge for refund consideration.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>All content including exercises, curriculum structure, illustrations, and user interface design is owned by HyeLearn. The Armenian alphabet and language are not copyrightable, but our specific presentation, exercises, and curriculum are. Teachers retain ownership of custom content they create using the platform.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-brown-800">7. Limitation of Liability</h2>
            <p>The service is provided &ldquo;as is&rdquo; without warranties of any kind. HyeLearn is not liable for learning outcomes. Our maximum liability is limited to fees you have paid in the last 12 months.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-brown-800">8. Termination</h2>
            <p>We may terminate accounts that violate these terms. You can delete your account at any time by contacting support@hyelearn.com.</p>
          </section>
